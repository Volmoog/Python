...
def nouvellePartie():
    global humainCommence, humainJoue, partieFinie, etatJeu, nombreCoups
...
def machineJoue():
    global humainCommence, humainJoue, partieFinie,nombreCoups
    i = randrange(3)
    j = randrange(3)
...
def verifiePlateau():
    ...
    if not(partieFinie):
        ...
        for i in range(2):
            for j in range(2):
                if etatJeu[0][0] == etatJeu[1][0] == etatJeu[2][0] !=0: #ligne 1
                    partieFinie = True
                elif etatJeu[0][1] == etatJeu[1][1] == etatJeu[2][1] != 0: # ligne 2
                    partieFinie = True
                elif etatJeu[0][2] == etatJeu[1][2] == etatJeu[2][2] != 0: #ligne 3
                    partieFinie = True
                elif etatJeu[0][0] == etatJeu[0][1] == etatJeu[0][2] != 0: #colonne 1
                    partieFinie = True
                elif etatJeu[1][0] == etatJeu[1][1] == etatJeu[1][2] != 0: # colonne 2
                    partieFinie = True
                elif etatJeu[2][0] == etatJeu[2][1] == etatJeu[2][2] != 0: #colonne 3
                    partieFinie = True
                elif etatJeu[0][0] == etatJeu[1][1] == etatJeu[2][2] != 0: # diagonale 1
                    partieFinie = True
                elif etatJeu[0][2] == etatJeu[1][1] == etatJeu[2][0] != 0: #diagonale 2
                    partieFinie = True
                elif nombreCoups == 9:
                    partieFinie = True
                else:
